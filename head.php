...
<html lang="en">
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="<?php echo $conf['ico']; ?>">
        <!-- App css -->
        <!-- build:css -->
                    ...
                    <ul class="metismenu side-nav">
                        ...
                        <li class="side-nav-item">
                            ...
                            <ul class="side-nav-second-level" aria-expanded="false">
                                <li>
                                    <a href="icp.php">ICP备案查询</a>
                                </li>
                                <li>
                                    <a href="ewm.php">二维码生成</a>
                                </li>
                                <li>
                                    <a href="ua.php">UA检测</a>
                                </li>
                                <li>
                                    <a href="audio.php">文字转语音</a>
                                </li>
                           ...
                           <li class="side-nav-item">
                            <a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['zzqq']; ?>&site=qq&menu=yes" class="side-nav-link">
                                <i class="dripicons-message"></i>
                                <span> 联系站长 </span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="<?php echo $conf['app']; ?>" class="side-nav-link">
                                <i class="dripicons-download"></i>
                                <span> APP下载 </span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="http://<?php echo $conf['qqqun']; ?>" class="side-nav-link">
